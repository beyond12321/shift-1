				...
				<div>
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<td id="subdate">2019-10-10</td>
						</tr>
						<tr>
							<td><strong>出发日期：</strong></td>
							<td id="sdate">2019-10-10</td>
						</tr>
						<tr>
							<td><strong>返回日期：</strong></td>
							<td id="edate">2019-10-10</td>
						</tr>
						<tr>
							<td><strong>目的地：</strong></td>
							<td id="dest">北京市xxxxxx</td>
						</tr>
					</table>
				</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title"> 
								<a data-toggle="collapse" data-parent="news" href="#contentOne">
									<strong><span class="glyphicon glyphicon-user"></span>&nbsp;出差人员安排（总人数：<span id="allCount"></span>）</strong>
								</a>
							</h4>
						</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="news" href="#contentTwo">
									<strong><span class="glyphicon glyphicon-list-alt"></span>&nbsp;出差费用支出项（总费用￥<span id="allPrice2" class="text-danger h2"></span>）</strong>
								</a>
							</h4>
						</div>
